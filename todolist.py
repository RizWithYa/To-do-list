...
class App(ctk.CTk):
    ...
    def _create_fab(self):
        self.fab_button = ctk.CTkButton(self, text="+", font=ctk.CTkFont(size=28, weight="bold"), width=55, height=55, corner_radius=30, command=self.open_add_task_window)
    ...
    def add_task_from_popup(self, task_entry, date_picker, hour_var, minute_var, window):
        ...
        self.all_tasks_data.append(new_task_data); self._save_and_refresh_ui(); window.destroy()
